...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:17:00
...
(1, 7, 1, '2026-02-18', 'mas toallas'),
(2, 10, 3, '2026-03-14', 'mas bebidas'),
(3, 1, 2, '0000-00-00', 'limpieza'),
(4, 7, 5, '2026-02-27', 'cambio de sabanas '),
(5, 1, 1, '2026-02-01', 'limpieza');
...
(1, 9, '2026-02-17', 100, 'tarjeta de credito', '67679', 'aceptado'),
(2, 7, '2026-02-17', 2000, 'tarjeta de credito', '5490', 'en proceso'),
(3, 3, '2030-06-01', 800, 'tarjeta de credito', '3287', 'aceptado'),
(4, 5, '2026-02-08', 4000, 'tarjeta de credito', '5963', 'aceptado'),
(5, 5, '2026-03-13', 700, 'tarjeta de credito', '8888', 'aceptado');
...
(2, 'wifi', 200),
(3, 'minibar', 450),
(4, 'Servicios para mascotas', 1000),
(5, 'Traslado al aeropuerto o transporte local.', 500);
